...
@section('title', 'Data Pesanan & Penawaran')
                    ...
                    <td class="px-6 py-4 text-center">
                        <div class="flex justify-center items-center gap-2">
                            ...
                            <form action="{{ route('orders.destroy', $order->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus pesanan ini beserta rincian bahannya?');">
                                @csrf @method('DELETE')
                                <button type="submit" class="p-2 bg-gray-50 text-red-500 hover:bg-red-100 rounded-lg transition border border-gray-200" title="Hapus Pesanan">
