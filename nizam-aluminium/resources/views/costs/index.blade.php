        ...
        <table class="w-full text-sm text-left text-gray-500">
            <thead class="text-[11px] text-gray-400 uppercase bg-gray-50 border-b border-gray-100 tracking-wider">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-4 font-bold">Deskripsi Belanja</th>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b border-gray-50 hover:bg-blue-50/30 transition">
                    ...
                    <td class="px-6 py-4 text-center flex justify-center space-x-2">
                        ...
                        <!-- TOMBOL EDIT -->
                        <a href="{{ route('costs.edit', $cost->id) }}" class="text-yellow-600 hover:text-white border border-yellow-500 hover:bg-yellow-600 font-medium rounded-lg text-xs px-3 py-1.5 transition whitespace-nowrap">Edit</a>
                ...
                @empty
                <tr><td colspan="6" class="px-6 py-8 text-center text-gray-400">Belum ada data pengeluaran.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
