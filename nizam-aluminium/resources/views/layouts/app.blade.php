...
<body class="font-sans antialiased bg-gray-100 text-gray-900 flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-slate-900 flex flex-col h-screen flex-shrink-0 z-20 shadow-xl text-gray-300">
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-4 flex flex-col custom-scrollbar space-y-1">
            ...
            <!-- Kategori Transaksi -->
            <p class="px-3 text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 mt-2">TRANSAKSI</p>
            ...
            <a href="{{ route('costs.index') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('costs.*') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-800' }}">
            ...
            <p class="px-3 text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 mt-2">LAPORAN</p>
            
            <a href="{{ route('reports.jobCosting') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('reports.jobCosting') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-800' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                Cetak HPP
            </a>
            
            <a href="{{ route('reports.receivables') }}" class="flex items-center px-4 py-3 text-sm font-medium rounded-lg mb-4 transition-colors {{ request()->routeIs('reports.receivables') ? 'bg-blue-600 text-white shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-800' }}">
        ...
        <!-- Area Profil & Logout (Sudah Diperbaiki) -->
        <div class="p-4 border-t border-slate-800 bg-slate-950">
            <div class="flex items-center mb-4 px-2">
                <!-- flex-shrink-0 mencegah huruf A tergencet -->
